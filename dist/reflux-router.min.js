...
if(u&&!n){var c=o._routingMarker,g=location.href,R=g.substring(0,g.indexOf(c)+c.length),p=t===o._defaultRoute?R:R+t
window.history.pushState({reflux_route:t},(a?a.title:f)||null,p)}a&&(a.action?a.action.apply(null,a.argmnts):a.state&&r.setGlobalState(a.state))
var h=a&&a.title||f
return l&&h&&(document.title=h),h||null},o})
